      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "I landed my dream job as a Data Engineer within weeks, thanks to
            the personalized support and exclusive openings provided by this
            platform."
          </blockquote>
