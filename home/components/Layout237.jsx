        ...
        <div className="flex flex-col items-center">
          <div className="rb-12 mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
            ...
            <p className="md:text-md">
              Experience unparalleled career growth with our proven pay and
              promotion statistics. Join a network where your success is our
              priority.
            </p>
          </div>
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>Discover opportunities that 80% of candidates never see.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              <div className="rb-5 mb-5 md:mb-6">
                <img
              ...
              <h3 className="mb-5 text-2xl font-bold md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
                Your Personal Advocate Awaits
              </h3>
              <p>Receive dedicated support from a recruiter within 24 hours.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              <div className="rb-5 mb-5 md:mb-6">
                <img
              ...
              <p>
                Become part of a thriving network that champions your career.
              </p>
            </div>
          </div>
